...
*/
const ahrs_data_t& AHRS::read_imu_and_update_orientation(uint32_t time_microseconds, uint32_t time_microsecondsDelta, IMU_FiltersBase& imu_filters, VehicleControllerBase& vehicle_controller)
{
